...
/**
 * For this Live Test we need: * a running instance of the service located in
 * the spring-boot-admin/spring-boot-admin-server module.
 * 
 * @see <a href=
 *      "https://github.com/eugenp/tutorials/tree/master/spring-boot-admin/spring-boot-admin-server">spring-boot-admin/spring-boot-admin-server
 *      module</a>
 * 
 */
public class BasicPreemptiveAuthenticationLiveTest {
	...
	public void givenNoAuthentication_whenRequestSecuredResource_thenUnauthorizedResponse() {
		...
		.then()
			...
			.contentType(containsString("<form")).and()
			.contentType(containsString("action=\"login\""));
	}
