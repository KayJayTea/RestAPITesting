...
public class TwitterSoftAssertExample {
	...
	public void readTweets() {
		...
		.then()
			...
			.statusCode(200)
			.body(
					"user.name", hasItem("Stumps"),
					"entities.user_mentions[0].screen_name", hasItem("BBCWorld1"),
					"entities.user_mentions[0].size", lessThan(2),
					"entities.user_mentions[1].size", equalTo(3)
				);
	}
}
