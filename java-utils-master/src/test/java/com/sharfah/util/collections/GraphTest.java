...
public class GraphTest {
	...
	public void testDepthFirstSearch() {
		...
		MatcherAssert.assertThat(result, is(Arrays.asList(0, 1, 3, 2, 4, 5)));
	}
	...
	public void testBreadthFirstSearch() {
		...
		MatcherAssert.assertThat(result, is(Arrays.asList(0, 1, 4, 5, 3, 2)));
	}

	@Test
	public void testPathExists() {
		MatcherAssert.assertThat(Graph.pathExists(root, two), is(true));
		MatcherAssert.assertThat(Graph.pathExists(two, five), is(false));
	}
}
